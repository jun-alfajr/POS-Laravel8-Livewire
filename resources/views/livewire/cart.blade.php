	...
	<div class="col-md-8">
		<div class="card">
			<div class="card-header bg-white">
				<div class="row">
					<div class="col-md-6"><h3 class="font-weight-bold">Products List</h2></div>
					...
					<div class="row">
						...
						<div class="col-md-3 mb-3" :key="{{ $product->id }}">
							<div class="card" wire:click="addItem({{ $product->id }})" style="cursor: pointer;">
								...
								<button wire:click="addItem({{ $product->id }})" class="btn btn-primary btn-sm btn" style="position: absolute; top: 0; right: 0; padding: 10px 15px"> <i class="fas fa-cart-plus fa-lg"></i>
								</button>
							</div>
		...
		<div class="col-md-4">
			<div class="card">
				<div class="card-header bg-white"x>
